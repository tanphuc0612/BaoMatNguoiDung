 ...
 * @author Hp
 */
public class ThanhVienWithCheckBox {
    private int MaTV;
    private String Ten;
    private String Phai;
    ...
    public ThanhVienWithCheckBox(int aInt, String string, String string0, String string1, Date date) {
    ...
    public ThanhVienWithCheckBox(int MaTV, String Ten, String Phai, String QueQuan, Date NgaySinh, String QuocTich, String DCThuongTru, String DCTamTru, String NoiCongTac, int TrangThai, String LyDo, int MaDV, String Username, int DuocBau) {
        this.MaTV = MaTV;
        this.Ten = Ten;
        this.Phai = Phai;
